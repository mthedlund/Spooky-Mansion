...
create_exit(basement, "teleporter", "You can fit through a small crack leading to another room.")
...
teleporter = create_room("teleporter", """You have descovered a small metal room with electricity flying everywhere.
I wonder if this can randomly take you somewhere secret that is impossible to get to otherwise.
Enter anything to be teleported.""")

moon = create_room("moon", """You find yourself enclosed inside a large capsule.""")
create_exit(moon, "space", "There is a large metal door you can open.")
space = create_room("space", """You gaze out into the abyss and see Earth far in the distance.
You have somehow ended up on the moon.
Although far from home, you are definitely free.""", ends_game=True)
